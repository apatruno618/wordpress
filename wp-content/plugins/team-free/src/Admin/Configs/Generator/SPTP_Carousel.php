			...
			array(
				...
				'fields' => array(
					...
					array(
						...
						'subtitle'   => __( 'On/Off auto play.', 'team-free' ),
						'default'    => 'true',
					...
					array(
						...
						'subtitle'   => __( 'On/Off carousel pause on hover.', 'team-free' ),
						'default'    => 'true',
						'dependency' => array( 'carousel_mode|carousel_autoplay', '==|==', 'standard|true' ),
					),
					array(
						...
						'subtitle'   => __( 'On/Off infinite loop mode.', 'team-free' ),
						'default'    => 'true',
						'dependency' => array( 'carousel_mode', '==', 'standard' ),
					),
					array(
						...
						'subtitle'   => __( 'On/Off auto height for the carousel.', 'team-free' ),
						'default'    => 'true',
						'dependency' => array( 'carousel_mode', '==', 'standard' ),
					),
					array(
						...
						'type'     => 'column',
						'title'    => __( 'Row', 'wp-team-pro' ),
						'subtitle' => __( 'Set number of rows in different devices for responsive view.', 'wp-team-pro' ),
						'default'  => array(
							'desktop' => '1',
							'laptop'  => '1',
							'tablet'  => '1',
					...
					array(
						...
						'type'       => 'color_group',
						'title'      => __( 'Navigation Color', 'team-free' ),
					...
					array(
						...
						'type'       => 'border',
						'title'      => __( 'Navigation Border', 'team-free' ),
					...
					array(
						...
						'type'       => 'switcher',
						'title'      => __( 'Pagination Dots', 'team-free' ),
