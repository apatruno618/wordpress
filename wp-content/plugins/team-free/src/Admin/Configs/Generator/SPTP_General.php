			...
			array(
				...
				'fields' => array(
					...
					array(
						...
						'type'       => 'switcher',
						'title'      => __( 'Ajax Live Filter', 'wp-team-pro' ),
						'subtitle'   => __( 'Enable/Disable ajax live filtering for member groups.', 'wp-team-pro' ),
					...
					array(
						...
						'type'       => 'switcher',
						'title'      => __( 'Ajax Member Search', 'wp-team-pro' ),
						'subtitle'   => __( 'Enable/Disable ajax search for member.', 'wp-team-pro' ),
						'text_on'    => __( 'Enabled', 'wp-team-pro' ),
						'text_off'   => __( 'Disabled', 'wp-team-pro' ),
						'default'    => false,
						'text_width' => 96,
