			...
			array(
				...
				'fields' => array(
					array(
						...
						'help'    => __( 'Check this box if you would like WP Team to completely clean-up all of its data when the plugin is deleted.', 'team-free' ),
						'default' => false,
					),
					array(
						'id'         => 'sptf_use_cache',
						...
						'help'       => __( 'Enable/Disable plugin cache. To make WP Team faster, keep enable cache. The cache is enabled by default.', 'team-free' ),
						'default'    => true,
					...
					array(
						...
						// 'help'    => __( 'Check this box if you would like WP Team Pro to completely remove all of its data when the plugin is deleted.', 'wp-team-pro' ),
						'default' => false,
					),
					array(
						'type'    => 'subheading',
