; (function ($, window, document, undefined) {
  ...
  //             data: $this.find('.spf-import-data').val()
  //           })
  //           .done(function (response) {
  //             window.location.reload(true)
  //           })
  ...
  //     var $this = $(this),
  //       $map = $this.find('.spf--map-osm'),
  //       $search_input = $this.find('.spf--map-search input'),
  //       $latitude = $this.find('.spf--latitude'),
  //       $longitude = $this.find('.spf--longitude'),
  //       $zoom = $this.find('.spf--zoom'),
  ...
  //       $search_input = $(
  //         '[data-depend-id="' +
  //           $this.find('.spf--address-field').data('address-field') +
  //           '"]'
  //       )
  //     }
  ...
  //         $(this)
  //           .autocomplete('widget')
  //           .addClass('spf-map-ui-autocomplate')
  //       }
  //     })
  ...
  // Field: link
  //
  // $.fn.spf_field_link = function () {
  //   return this.each(function () {
  //     var $this = $(this),
  //       $link = $this.find('.spf--link'),
  //       $add = $this.find('.spf--add'),
  //       $edit = $this.find('.spf--edit'),
  //       $remove = $this.find('.spf--remove'),
  //       $result = $this.find('.spf--result'),
  //       uniqid = SPF.helper.uid('spf-wplink-textarea-')
  ...
  //       $('#wp-link-url').val($this.find('.spf--url').val())
  //       $('#wp-link-text').val($this.find('.spf--text').val())
  //       $('#wp-link-target').prop(
  //         'checked',
  //         $this.find('.spf--target').val() === '_blank'
  //       )
  //     })
  ...
  //         .val('')
  //         .trigger('change')
  //       $this.find('.spf--text').val('')
  //       $this.find('.spf--target').val('')
  ...
  //         .val(href)
  //         .trigger('change')
  //       $this.find('.spf--text').val(text)
  //       $this.find('.spf--target').val(target)
  ...
  //         '',
  //       $auto_attributes = $this.hasClass('spf-assign-field-background')
  //         ? $this.closest('.spf-field-background').find('.spf--auto-attributes')
  //         : false,
  //       wp_media_frame
  ...
  //         if ($auto_attributes) {
  //           $auto_attributes.removeClass('spf--attributes-hidden')
  //         }
  ...
  //       if ($auto_attributes) {
  //         $auto_attributes.addClass('spf--attributes-hidden')
  //       }
