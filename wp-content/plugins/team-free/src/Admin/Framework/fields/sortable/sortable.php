 ...
 * @version 1.0.0
 */
if ( ! class_exists( 'TEAMFW_Field_sortable' ) ) {
	class TEAMFW_Field_sortable extends TEAMFW_Fields {
		...
		public function render() {
			...
			echo '<div class="spf-sortable" data-depend-id="' . esc_attr( $this->field['id'] ) . '">';
			...
			foreach ( $pre_sortby as $key => $field ) {
				...
				SPF_TEAM::field( $field, $field_value, $unique_id, 'field/sortable' );

				echo '</div>';

				echo '<div class="spf-sortable-helper"><i class="fas fa-arrows-alt"></i></div>';
