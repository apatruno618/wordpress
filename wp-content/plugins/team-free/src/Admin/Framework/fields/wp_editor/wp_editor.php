 ...
 *
 */
if ( ! class_exists( 'TEAMFW_Field_wp_editor' ) ) {
  class TEAMFW_Field_wp_editor extends TEAMFW_Fields {
    ...
    public function render() {
      ...
      echo ( spf_wp_editor_api() ) ? '<div class="spf-wp-editor" data-editor-settings="'. esc_attr( json_encode( $editor_settings ) ) .'">' : '';
    ...
    public function setup_wp_editor_media_buttons() {
      ...
      echo 'var spf_media_buttons = '. json_encode( $media_buttons ) .';';
      echo '</script>';
