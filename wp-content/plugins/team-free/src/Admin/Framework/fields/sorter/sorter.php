 ...
 *
 */
if ( ! class_exists( 'TEAMFW_Field_sorter' ) ) {
  class TEAMFW_Field_sorter extends TEAMFW_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        'disabled'       => true,
        'enabled_title'  => esc_html__( 'Enabled', 'team-free' ),
        'disabled_title' => esc_html__( 'Disabled', 'team-free' ),
      ) );
      ...
      echo '<div class="spf-sorter" data-depend-id="'. esc_attr( $this->field['id'] ) .'"></div>';

      echo ( $args['disabled'] ) ? '<div class="spf-modules">' : '';

      echo ( ! empty( $args['enabled_title'] ) ) ? '<div class="spf-sorter-title">'. esc_attr( $args['enabled_title'] ) .'</div>' : '';
      ...
      if ( $args['disabled'] ) {
        ...
        echo ( ! empty( $args['disabled_title'] ) ) ? '<div class="spf-sorter-title">'. esc_attr( $args['disabled_title'] ) .'</div>' : '';
