		...
		public function render() {
			...
			$args = wp_parse_args(
				...
				array(
					...
					'desktop_placeholder' => esc_html__( 'Desktop', 'wp-team-pro' ),
					'laptop_placeholder'  => esc_html__( 'Small Desktop', 'wp-team-pro' ),
					'tablet_placeholder'  => esc_html__( 'Tablet', 'wp-team-pro' ),
					'mobile_placeholder'  => esc_html__( 'Mobile', 'wp-team-pro' ),
					'all_placeholder'     => esc_html__( 'all', 'wp-team-pro' ),
					'desktop'             => true,
					'laptop'              => true,
					'tablet'              => true,
					'mobile'              => true,
			...
			if ( ! empty( $args['all'] ) ) {
				...
				echo ( ! empty( $args['all_text'] ) ) ? '<span class="spf--label spf--icon">' . $args['all_text'] . '</span>' : '';
