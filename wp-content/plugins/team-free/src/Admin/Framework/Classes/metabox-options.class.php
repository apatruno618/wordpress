	...
	class TEAMFW_Metabox extends TEAMFW_Abstract {
		...
		public function add_meta_box_content( $post, $callback ) {
			...
			if ( $has_nav ) {
				...
				echo '<div class="spf-nav spf-nav-' . esc_attr( $nav_type ) . ' spf-nav-metabox" data-unique="' . $this->unique . '">';  // ShapedPlugin - Customized.
				...
				foreach ( $this->sections as $section ) {
					...
					echo '<li class="spf-menu-item-' . esc_attr( $menu_title ) . '"><a href="#" data-section="' . $this->unique . '_' . $tab_key . '">' . $tab_icon . $section['title'] . $tab_error . '</a></li>';
			...
			echo '<a class="btn btn-success" id="sp__team-show-preview" data-id="' . $post->ID . '"href=""> <i class="fa fa-eye" aria-hidden="true"></i> Show Preview</a>';
