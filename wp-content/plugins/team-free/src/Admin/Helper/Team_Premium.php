				...
				<div class="row">
					<div class="sp-team-col-xl-6">
						<div class="sp-team-banner-content">
							...
							<h4 class="sp-team-mt-10 sp-team-font-18 sp-team-font-weight-500"><?php _e( 'Supercharge <strong>Your Team Page</strong> with powerful functionality!', 'team-free' ); ?></h4>
