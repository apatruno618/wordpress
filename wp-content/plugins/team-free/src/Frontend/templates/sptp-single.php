...
while ( have_posts() ) :
	...
	if ( isset( $sptp_settings['detail_page_fields'] ) ) {
		...
		$show_name            = in_array( 'name', $detail_fields );
		$show_img             = in_array( 'img', $detail_fields );
		$show_desc            = in_array( 'desc', $detail_fields );
		$show_position        = in_array( 'position', $detail_fields );
		$show_social_profiles = in_array( 'social_profiles', $detail_fields );
	}
	?>
